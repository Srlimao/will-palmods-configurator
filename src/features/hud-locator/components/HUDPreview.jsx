          ...
          {config.Global.Enabled && config.Players.Enabled && (
            <div className={styles.hudLabel}>
              ...
              >
                ...
                <span className={styles.nameplateDist} style={{ color: getTextColor(config.Players.Style.DistColor), fontSize: `${config.Players.Style.SmallFontScale}em` }}>156m</span>
              </div>
            </div>
          )}
          ...
          {config.Global.Enabled && config.Relics.Enabled && (
            <div className={styles.hudLabel} style={{ top: 40, left: 50 }}>
              ...
              >
                ...
                <span className={styles.nameplateDist} style={{ color: getTextColor(config.Relics.Style.DistColor), fontSize: `${config.Relics.Style.SmallFontScale}em` }}>45m</span>
              </div>
            </div>
          )}
          ...
          {config.Global.Enabled && config.Chests.Enabled && (
            <div className={styles.hudLabel} style={{ bottom: 40, right: 50 }}>
              ...
              >
                ...
                <span className={styles.nameplateDist} style={{ color: getTextColor(config.Chests.Style.DistColor), fontSize: `${config.Chests.Style.SmallFontScale}em` }}>12m</span>
              </div>
            </div>
          )}
          ...
          {config.Global.Enabled && config.Eggs.Filter !== "None" && (
            <div className={styles.hudLabel} style={{ top: 60, right: 60 }}>
              ...
              >
                ...
                <span className={styles.nameplateDist} style={{ color: getTextColor(config.Eggs.Style.DistColor), fontSize: `${config.Eggs.Style.SmallFontScale}em` }}>8m</span>
              </div>
            </div>
          )}
          ...
          {config.Global.Enabled && config.Caves.Enabled && (
            <div className={styles.hudLabel} style={{ top: 100, left: 80 }}>
              ...
              >
                ...
                <span className={styles.nameplateDist} style={{ color: getTextColor(config.Caves.Style.DistColor), fontSize: `${config.Caves.Style.SmallFontScale}em` }}>110m</span>
              </div>
            </div>
          )}
        </div>
